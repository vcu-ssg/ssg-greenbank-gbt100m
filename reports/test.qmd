...
output = f"../docs/data/{root}-0.ply"
x = shutil.copyfile( input, output )

input  = f"../projects/{root}/colmap/sparse/0_clean.ply"
output = f"../docs/data/{root}-0_clean.ply"
x = shutil.copyfile( input, output )

input = f"../projects/{root}/images/{root}_00001.jpg"
output = f"../docs/data/{root}-image.jpg"
x = shutil.copyfile( input, output )
...
<div class="viewer-block">
<h3>Initial photo</h3>
<div class="threejs-container"><img src="./data/DJI_0145-jpg_base_1.60_1600-image.jpg"/></div>
</div>
</div>
...
<script type="module">
  ...
  loadPLYViewer("viewer1", "./0.ply");
  loadPLYViewer("viewer2", "./0_clean.ply");
</script>
```
