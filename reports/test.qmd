...
root = "DJI_0145-png_base_1.60_1600"
...
input  = f"../projects/{root}/colmap/sparse/0_clean2.ply"
model3 = f"../docs/data/{root}-0_clean2.ply"
x = shutil.copyfile( input, model3 )

input = f"../projects/{root}/images/{root}_00001.png"
initial_image = f"../docs/data/{root}-image.png"
...
df = pd.DataFrame(data, columns=["Parameter", "Value"])
html_table3 = df.to_html(index=False, classes="stats-table", border=0)
...
<div class="viewer-block">
<h3>Cleaned model</h3>
<div id="viewer3" class="threejs-container"></div>
<div>{html_table2}</div>
</div>
<div class="viewer-block">
<h3>Cleaned2 model</h3>
<div id="viewer4" class="threejs-container"></div>
<div>{html_table3}</div>
</div>
</div>
...
<div class="viewer-block">
<h3>Initial photo</h3>
<div class="threejs-container"><img src="./data/{root}-image.png"/></div>
</div>
</div>
...
<script type="module">
  ...
  loadPLYViewer("viewer1", "./data/DJI_0145-png_base_1.60_1600-0.ply");
  loadPLYViewer("viewer2", "./data/DJI_0145-png_base_1.60_1600-0_clean.ply");
  loadPLYViewer("viewer3", "./data/DJI_0145-png_base_1.60_1600-0_clean.ply");
  loadPLYViewer("viewer4", "./data/DJI_0145-png_base_1.60_1600-0_clean2.ply");
